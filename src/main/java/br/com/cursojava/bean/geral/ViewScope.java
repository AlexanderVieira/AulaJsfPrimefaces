...
public class ViewScope implements Scope, Serializable {
	...
	public static final String VIEW_SCOPE_CALLBACKS = "veiwScope.callBacks";

	@Override
	public Object get(String name, ObjectFactory<?> objetcFactory) {
		Object instance = getViewMap().get(name);
		if (instance == null) {
			instance = objetcFactory.getObject();
	...
	// getViewMap retorna u Map que atua como a interface para o armazenamento de
	// dados
